...
const AdvancedForm = ({
    ...
    const handleSubmit = async (values) => {
        try {
            // If Yup validation schema is provided, validate with it
            if (validationSchema) {
    ...
    return (
        <div className={`advanced-form-container ${className}`}>
            ...
            <CommonForm
                ...
                onCancel={onCancel}
                form={formInstance}
                submitButtonText={submitButtonText || (isEditing ? 'Update' : 'Create')}
    ...
    fields: PropTypes.arrayOf(
        PropTypes.shape({
            ...
            type: PropTypes.oneOf([
                ...
                'select', 'date', 'switch', 'checkbox', 'radio'
            ]),
